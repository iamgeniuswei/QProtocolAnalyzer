...
${OBJECTDIR}/src/QPAMapHelper.o: src/QPAMapHelper.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/QPAMapHelper.o src/QPAMapHelper.cpp
...
${OBJECTDIR}/src/nstime.o: src/nstime.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/nstime.o src/nstime.cpp

${OBJECTDIR}/src/str_util.o: src/str_util.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/str_util.o src/str_util.cpp

${OBJECTDIR}/src/time_util.o: src/time_util.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/time_util.o src/time_util.cpp

${OBJECTDIR}/src/ws_mempbrk.o: src/ws_mempbrk.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ws_mempbrk.o src/ws_mempbrk.cpp
