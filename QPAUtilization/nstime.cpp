...
bool nstime_t::nstime_is_zero() const
{
    if(secs == 0 && nsecs ==0)
        return true;
    else
...
void nstime_t::nstime_set_unset()
{
    secs = 0;
    nsecs = INT_MAX;
}

bool nstime_t::nstime_is_unset() const
{
    if(secs == 0 && nsecs == INT_MAX)
        return true;
    else
        return false;
}

nstime_t &nstime_t::nstime_delta(const nstime_t &b, const nstime_t &a)
{
//    if(b.secs == a.secs)
//    {
//        secs = 0;
...
nstime_t &nstime_t::nstime_sum(const nstime_t &b, const nstime_t &a)
{
    return *this;
}

int nstime_t::nstime_cmp(const nstime_t &a)
{
    return 0;
}
