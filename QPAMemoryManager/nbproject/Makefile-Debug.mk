...
${OBJECTDIR}/src/wmem_allocator_block.o: src/wmem_allocator_block.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/wmem_allocator_block.o src/wmem_allocator_block.cpp

${OBJECTDIR}/src/wmem_allocator_block_fast.o: src/wmem_allocator_block_fast.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/wmem_allocator_block_fast.o src/wmem_allocator_block_fast.cpp

${OBJECTDIR}/src/wmem_allocator_simple.o: src/wmem_allocator_simple.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/wmem_allocator_simple.o src/wmem_allocator_simple.cpp

${OBJECTDIR}/src/wmem_allocator_strict.o: src/wmem_allocator_strict.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/wmem_allocator_strict.o src/wmem_allocator_strict.cpp

${OBJECTDIR}/src/wmem_array.o: src/wmem_array.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/wmem_array.o src/wmem_array.cpp

${OBJECTDIR}/src/wmem_core.o: src/wmem_core.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/wmem_core.o src/wmem_core.cpp

${OBJECTDIR}/src/wmem_interval_tree.o: src/wmem_interval_tree.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/wmem_interval_tree.o src/wmem_interval_tree.cpp

${OBJECTDIR}/src/wmem_list.o: src/wmem_list.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/wmem_list.o src/wmem_list.cpp

${OBJECTDIR}/src/wmem_map.o: src/wmem_map.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/wmem_map.o src/wmem_map.cpp

${OBJECTDIR}/src/wmem_miscutl.o: src/wmem_miscutl.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/wmem_miscutl.o src/wmem_miscutl.cpp

${OBJECTDIR}/src/wmem_scopes.o: src/wmem_scopes.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/wmem_scopes.o src/wmem_scopes.cpp

${OBJECTDIR}/src/wmem_stack.o: src/wmem_stack.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/wmem_stack.o src/wmem_stack.cpp

${OBJECTDIR}/src/wmem_strbuf.o: src/wmem_strbuf.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/wmem_strbuf.o src/wmem_strbuf.cpp

${OBJECTDIR}/src/wmem_strutl.o: src/wmem_strutl.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/wmem_strutl.o src/wmem_strutl.cpp

${OBJECTDIR}/src/wmem_tree.o: src/wmem_tree.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/wmem_tree.o src/wmem_tree.cpp

${OBJECTDIR}/src/wmem_user_cb.o: src/wmem_user_cb.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/wmem_user_cb.o src/wmem_user_cb.cpp
