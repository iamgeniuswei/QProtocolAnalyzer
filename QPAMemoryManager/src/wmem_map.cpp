...
static gboolean
wmem_map_reset_cb(wmem_allocator_t *allocator , wmem_cb_event_t event,
        void *user_data)
{
...
static gboolean
wmem_map_destroy_cb(wmem_allocator_t *allocator , wmem_cb_event_t event ,
        void *user_data)
{
    wmem_map_t *map = (wmem_map_t*)user_data;
