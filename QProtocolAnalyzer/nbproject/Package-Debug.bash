...
OUTPUT_PATH=${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/qprotocolanalyzer
OUTPUT_BASENAME=qprotocolanalyzer
PACKAGE_TOP_DIR=qprotocolanalyzer/
...
# Generate tar file
cd "${TOP}"
rm -f ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/package/qprotocolanalyzer.tar
cd ${NBTMPDIR}
tar -vcf ../../../../${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/package/qprotocolanalyzer.tar *
checkReturnCode
