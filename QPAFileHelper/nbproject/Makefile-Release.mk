...
${OBJECTDIR}/src/QPAAbstractFile.o: src/QPAAbstractFile.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/QPAAbstractFile.o src/QPAAbstractFile.cpp

${OBJECTDIR}/src/QPAAbstractPacketHeader.o: src/QPAAbstractPacketHeader.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/QPAAbstractPacketHeader.o src/QPAAbstractPacketHeader.cpp
...
${OBJECTDIR}/src/QPAFileReader.o: src/QPAFileReader.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/QPAFileReader.o src/QPAFileReader.cpp

${OBJECTDIR}/src/QPAOpenRoutine.o: src/QPAOpenRoutine.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/QPAOpenRoutine.o src/QPAOpenRoutine.cpp

${OBJECTDIR}/src/QPAPcapOpenRoutine.o: src/QPAPcapOpenRoutine.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/QPAPcapOpenRoutine.o src/QPAPcapOpenRoutine.cpp
