...
static gboolean
wmem_test_foreach_cb(const void *key , void *value, void *user_data)
{
...
void
check_val_map(gpointer key , gpointer val, gpointer user_data)
{
...
static gboolean
wmem_test_itree_check_overlap_cb (const void *key, void *value , void *userData)
{
