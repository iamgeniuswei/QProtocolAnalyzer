...
${OBJECTDIR}/src/charsets.o: src/charsets.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/charsets.o src/charsets.cpp

${OBJECTDIR}/src/except.o: src/except.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/except.o src/except.cpp

${OBJECTDIR}/src/strutil.o: src/strutil.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/strutil.o src/strutil.cpp

${OBJECTDIR}/src/tvbuff.o: src/tvbuff.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tvbuff.o src/tvbuff.cpp
