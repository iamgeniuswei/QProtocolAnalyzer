 ...
 * Author: lenovo
 *
 * Created on September 25, 2017, 3:56 PM
 */
 ...
 */
extern void dissector_table_foreach_changed (const char *table_name, DATFunc func,
    gpointer user_data);
 ...
 * @param[in] user_data User data to pass to the function.
 */
extern void dissector_table_foreach (const char *table_name, DATFunc func,
    gpointer user_data);
 ...
 * @param[in] user_data User data to pass to the function.
 */
extern void dissector_table_foreach_handle(const char *table_name, DATFunc_handle func,
    gpointer user_data);
 ...
 */
extern dissector_table_t register_custom_dissector_table(const char *name,
...
/* Get the param set for the sub-dissector table,
   given the table's internal name */
extern int get_dissector_table_param(const char *name);

/* Dump all dissector tables to the standard output (not the entries,
   just the information about the tables) */
extern void dissector_dump_dissector_tables(void);

/* Add an entry to a uint dissector table. */
extern void dissector_add_uint(const char *name, const guint32 pattern,
    dissector_handle_t handle);

/* Add an entry to a uint dissector table with "preference" automatically added. */
extern void dissector_add_uint_with_preference(const char *name, const guint32 pattern,
    dissector_handle_t handle);

/* Add an range of entries to a uint dissector table. */
extern void dissector_add_uint_range(const char *abbrev, struct epan_range *range,
    dissector_handle_t handle);

/* Add an range of entries to a uint dissector table with "preference" automatically added. */
extern void dissector_add_uint_range_with_preference(const char *abbrev, const char* range_str,
    dissector_handle_t handle);
...
extern void dissector_delete_uint_range(const char *abbrev, struct epan_range *range,
    dissector_handle_t handle);

/* Delete all entries from a dissector table. */
extern void dissector_delete_all(const char *name, dissector_handle_t handle);
...
extern int dissector_try_uint(dissector_table_t sub_dissectors,
    const guint32 uint_val, tvbuff_t *tvb, packet_info *pinfo, proto_tree *tree);

/* Look for a given value in a given uint dissector table and, if found,
   call the dissector with the arguments supplied, and return the number
   of bytes consumed, otherwise return 0. */
extern int dissector_try_uint_new(dissector_table_t sub_dissectors,
 ...
 * @return The matching dissector handle on success, NULL if no match is found.
 */
extern dissector_handle_t dissector_get_default_uint_handle(
...
extern int dissector_try_string(dissector_table_t sub_dissectors,
 ...
 * @return The matching dissector handle on success, NULL if no match is found.
 */
extern dissector_handle_t dissector_get_default_string_handle(
    const char *name, const gchar *string);

/* Add an entry to a "custom" dissector table. */
extern void dissector_add_custom_table_handle(const char *name, void *pattern,
    dissector_handle_t handle);
 ...
 * @return The matching dissector handle on success, NULL if no match is found.
 */
extern dissector_handle_t dissector_get_custom_table_handle(
...
extern void dissector_add_guid(const char *name, guid_key* guid_val,
    dissector_handle_t handle);

/* Look for a given value in a given guid dissector table and, if found,
   call the dissector with the arguments supplied, and return TRUE,
   otherwise return FALSE. */
extern int dissector_try_guid(dissector_table_t sub_dissectors,
    guid_key* guid_val, tvbuff_t *tvb, packet_info *pinfo, proto_tree *tree);

/* Look for a given value in a given guid dissector table and, if found,
   call the dissector with the arguments supplied, and return TRUE,
   otherwise return FALSE. */
extern int dissector_try_guid_new(dissector_table_t sub_dissectors,
 ...
 * @return The matching dissector handle on success, NULL if no match is found.
 */
extern dissector_handle_t dissector_get_guid_handle(
...
extern int dissector_try_payload(dissector_table_t sub_dissectors,
    tvbuff_t *tvb, packet_info *pinfo, proto_tree *tree);

/* Use the currently assigned payload dissector for the dissector table and,
   if any, call the dissector with the arguments supplied, and return the
   number of bytes consumed, otherwise return 0. */
extern int dissector_try_payload_new(dissector_table_t sub_dissectors,
...
/* Change the entry for a dissector in a payload (FT_NONE) dissector table
   with a particular pattern to use a new dissector handle. */
extern void dissector_change_payload(const char *abbrev, dissector_handle_t handle);

/* Reset payload (FT_NONE) dissector table to its initial value. */
extern void dissector_reset_payload(const char *name);

/* Add a handle to the list of handles that *could* be used with this
   table.  That list is used by the "Decode As"/"-d" code in the UI. */
extern void dissector_add_for_decode_as(const char *name,
    dissector_handle_t handle);

/* Same as dissector_add_for_decode_as, but adds preference for dissector table value */
extern void dissector_add_for_decode_as_with_preference(const char *name,
    dissector_handle_t handle);

/** Get the list of handles for a dissector table
 */
extern GSList *dissector_table_get_dissector_handles(dissector_table_t dissector_table);

/** Get a handle to dissector out of a dissector table
 */
extern dissector_handle_t dissector_table_get_dissector_handle(dissector_table_t dissector_table, gchar* short_name);

/** Get a dissector table's type
 */
extern ftenum_t dissector_table_get_type(dissector_table_t dissector_table);

/** Mark a dissector table as allowing "Decode As"
 */
extern void dissector_table_allow_decode_as(dissector_table_t dissector_table);
 ...
 */
extern heur_dissector_list_t register_heur_dissector_list(const char *name, const int proto);
 ...
 * @param[in] user_data User data to pass to the function.
 */
extern void heur_dissector_table_foreach(const char *table_name,
...
extern gboolean has_heur_dissector_list(const gchar *name);
 ...
 */
extern heur_dissector_list_t find_heur_dissector_list(const char *name);
 ...
 */
extern heur_dtbl_entry_t* find_heur_dissector_by_unique_short_name(const char *short_name);
...
extern dissector_handle_t register_dissector(const char *name, dissector_t dissector, const int proto);
...
extern GList* get_dissector_names(void);
...
extern dissector_handle_t find_dissector_add_dependency(const char *name, const int parent_proto);

/** Get a dissector name from handle. */
extern const char *dissector_handle_get_dissector_name(const dissector_handle_t handle);

/** Create an anonymous handle for a dissector. */
extern dissector_handle_t create_dissector_handle(dissector_t dissector,
    const int proto);
extern dissector_handle_t create_dissector_handle_with_name(dissector_t dissector,
...
extern int call_data_dissector(tvbuff_t *tvb, packet_info *pinfo, proto_tree *tree);
...
extern void call_heur_dissector_direct(heur_dtbl_entry_t *heur_dtbl_entry, tvbuff_t *tvb,
    packet_info *pinfo, proto_tree *tree, void *data);
 ...
 */
extern gboolean register_depend_dissector(const char* parent, const char* dependent);
 ...
 */
extern gboolean deregister_depend_dissector(const char* parent, const char* dependent);
 ...
 */
extern depend_dissector_list_t find_depend_dissector_list(const char* name);
 ...
 */
extern void register_cleanup_routine(void (*func)(void));

/*
 * Register a shutdown routine to call once just before program exit
 */
extern void register_shutdown_routine(void (*func)(void));
 ...
 */
struct data_source;
extern char *get_data_source_name(const struct data_source *src);
extern tvbuff_t *get_data_source_tvb(const struct data_source *src);
extern tvbuff_t *get_data_source_tvb_by_name(packet_info *pinfo, const char *name);
 ...
 */
extern void register_postdissector(dissector_handle_t handle);
 ...
 */
extern void set_postdissector_wanted_hfids(dissector_handle_t handle,
    GArray *wanted_hfids);
 ...
 * FALSE otherwise.
 */
extern gboolean postdissectors_want_hfids(void);
